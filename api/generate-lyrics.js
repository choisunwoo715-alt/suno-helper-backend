...
2️⃣ **STRUCTURE & LINE LIMITS** (${timeline.info} @ 72-84 BPM):
   **⭐ COMPLETE SONG STRUCTURE (EVERY SECTION MANDATORY!):**
   ...
   - **[Key change up]** ← ⭐ MANDATORY SECTION TAG! Write this tag exactly!
   - **[Final Chorus]** (${timeline.final}): **${config.finalChorusMax} lines MAX!** ← ⭐ MANDATORY! (${config.finalChorusMax + 1}+ = guaranteed rap!)
   - [Outro] (${timeline.outro}): 2 lines
   
   ⚠️ **CRITICAL:** You MUST write ALL sections including [Key change up] and [Final Chorus]!
